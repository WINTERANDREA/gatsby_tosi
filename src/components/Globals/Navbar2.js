      ...
      <div className={state.css}>
        <ul className="navbar-nav mx-auto">
          {state.links.map(link => {
            return (
              <li key={link.id} className="nav-item text-green">
                <Link
                  to={link.path}
                  className="nav-link text-green nav-link2 text-capitalize"
                >
                  {link.text}
                </Link>
              </li>
          ...
          <li className="nav-item">
            <IoIosBasket className="cart-icon green snipcart-checkout" />
          </li>
        </ul>
      </div>
    </nav>
